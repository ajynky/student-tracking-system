		...
		return RouterFunctions
				.route(RequestPredicates.path("/auth/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(authServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build())

				.andRoute(RequestPredicates.path("/students/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(studentServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build())

				.andRoute(RequestPredicates.path("/classes/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(studentServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build())
				...
				.andRoute(RequestPredicates.path("/files/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(studentServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build())
				...
				.andRoute(RequestPredicates.path("/attendance/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(attendanceServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build())

				.andRoute(RequestPredicates.path("/grades/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(studentServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build())
				...
				.andRoute(RequestPredicates.path("/notifications/**"),
						request -> ServerResponse
								.temporaryRedirect(java.net.URI.create(notificationServiceUrl + request.uri().getPath()
										+ (request.uri().getQuery() != null ? "?" + request.uri().getQuery() : "")))
								.build());
	}
}